...
const hasContent = computed(
    () => props.courses.length > 0 || props.assignments.length > 0,
);
            ...
            <Transition name="hub-fade" mode="out-in">
                ...
                >
                    ...
                    >
                        ...
                        >
                            Nothing pending — you've completed all current
                    ...
                    >
                        <div
                            class="mb-2 flex items-center justify-between sm:mb-4"
                        >
                            <h4
                        ...
                        >
                            <div class="relative flex h-full w-full flex-col">
                                ...
                                <div
                                    class="relative z-10 space-y-1.5 sm:space-y-2"
                                >
                                    <div
