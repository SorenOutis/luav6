...
<template>
    ...
    >
            ...
            >
                <div class="grid gap-5">
                    ...
                    <div class="grid gap-2">
                        ...
                        >
                            We collect your name, email address, and password to
                            create and secure your account. Details are in the
                            <a
                                href="/privacy"
                                target="_blank"
                                rel="noopener"
        ...
        <p class="text-center text-xs leading-relaxed text-muted-foreground">
            Social sign up is also covered by our
            <a
                href="/terms"
                target="_blank"
                rel="noopener"
