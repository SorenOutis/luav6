        ...
        return $schema
            ...
            ->components([
                ...
                DateTimePicker::make('starts_at')
                    ...
                    ->default(fn (?Exam $record): ?string => $record === null ? now()->addDay()->setTime(9, 0)->format('Y-m-d H:i:s') : null)
                    ->native(false)
                ...
                DateTimePicker::make('ends_at')
                    ...
                    ->after('starts_at')
                    ->default(fn (?Exam $record): ?string => $record === null ? now()->addDay()->setTime(10, 0)->format('Y-m-d H:i:s') : null)
                    ->native(false)
                    ->displayFormat('Y-m-d H:i')
                    ->columnSpan(1),
