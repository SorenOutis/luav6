 ...
 * reverse proxies are allowed to rewrite LF framing to CRLF. Keeping the
 * parser line-oriented makes it resilient to both cases as well as `data:`
 * fields without a space and multi-line data payloads.
 */
...
/** Read and parse a fetch response body without making assumptions about chunk boundaries. */
