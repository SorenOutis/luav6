    ...
    >
        ...
        <div class="mb-4 text-center">
            ...
            <p class="text-xl font-black text-foreground tabular-nums">
                {{ currentStreak }}
                <span class="text-sm font-semibold text-muted-foreground/60"
                    >day streak</span
                >
            </p>
        ...
        <div class="mb-4 flex items-center justify-center gap-5 text-center">
            <div>
                <p
                    class="text-[9px] font-black tracking-[0.1em] text-muted-foreground/40 uppercase"
                >
                    Best
                </p>
                <p class="text-base font-black text-foreground tabular-nums">
                    {{ longestStreak }}
                    <span
        ...
        <div class="mb-2 flex items-center justify-between">
            <button
                @click="prevMonth"
                class="flex h-7 w-7 cursor-pointer items-center justify-center rounded-lg transition-all duration-200 hover:bg-muted/30"
            >
            ...
            <button
                ...
                class="flex h-7 w-7 cursor-pointer items-center justify-center rounded-lg transition-all duration-200 hover:bg-muted/30 disabled:cursor-not-allowed disabled:opacity-20"
            >
                ...
                >
                    <div
                        ...
                        :class="{
                            ...
                            'bg-orange-500/25 ring-2 ring-orange-400/40':
        ...
        >
            <span class="flex items-center gap-1.5 text-[9px]">
                <span
                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full bg-orange-500/15"
                >
                    <Check
