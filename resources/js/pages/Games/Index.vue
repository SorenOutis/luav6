        ...
        <template v-if="!isBooted">
            ...
            >
                ...
                <div class="z-10 grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div
                        class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2"
                    >
                        <div
                            v-for="i in 4"
                            :key="i"
                        ...
                        >
                            ...
                            <div class="flex flex-col gap-3 p-5">
                                <div
                                    class="h-4 w-3/4 animate-pulse rounded bg-primary/10"
                                ></div>
                                <div
                                    class="h-3 w-full animate-pulse rounded bg-primary/10"
                                ></div>
                                <div
                                    class="h-3 w-2/3 animate-pulse rounded bg-primary/10"
                                ></div>
                                <div
                                ...
                                >
                                    <div class="flex gap-4">
                                        <div
                                            class="h-8 w-16 animate-pulse rounded bg-primary/10"
                                        ></div>
                                        <div
                                            class="h-8 w-16 animate-pulse rounded bg-primary/10"
                                        ></div>
            ...
            >
                ...
                >
                    <div class="space-y-1">
                        ...
                        >
                            Challenge your cognitive boundaries. Earn credits
                            and boost your rank through competitive learning
                            modules.
                        </p>
                    </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="relative z-10">
                                    ...
                                    >
                                        All arcade progress is verified through
                                        the core assessment engine. Exploits
