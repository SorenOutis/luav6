...
const steps = [
    {
        ...
        description: 'Join your class by selecting your section. Teachers assign you to courses, exams, and assignments automatically.',
        details: [
    ...
    },
    {
        ...
        description: 'Complete exams, quizzes, and assignments directly in your browser. Multiple question types with instant AI feedback.',
        details: [
    ...
    },
    {
        ...
        description: 'Receive immediate results on auto-graded questions and AI-powered feedback on essays. Know where you stand right away.',
        details: [
    ...
    },
    {
        ...
        description: 'Monitor your grades, streaks, and XP across all subjects. The learning map shows your journey at every step.',
        details: [
    ...
    },
    {
        ...
        description: 'Stay motivated with achievements, seasonal rewards, and a gamified learning experience that makes progress fun.',
        details: [
...
<template>
    ...
    >
        ...
        <main class="relative z-10 mx-auto max-w-[900px] px-6 pt-24 pb-32 lg:px-16 lg:pt-32">
            <!-- Hero -->
            <section class="text-center">
                <div class="mb-6 inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-1.5">
                ...
                <p class="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                    LSI makes learning measurable, feedback instant, and progress visible. Here's how every step works.
                </p>
            </section>
                ...
                >
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center gap-3 md:hidden">
                            ...
                            <span class="text-sm font-medium text-muted-foreground">Step {{ i + 1 }}</span>
                        </div>
            ...
            <!-- CTA -->
            <section class="mt-32 rounded-2xl border border-border/20 bg-gradient-to-br from-primary/[0.04] via-transparent to-transparent p-10 text-center lg:p-16">
                <h2 class="text-3xl font-bold tracking-tight lg:text-4xl">
                    Ready to get started?
                </h2>
                <p class="mx-auto mt-3 max-w-lg text-muted-foreground">
                    Join your institution's learning journey. If you're a student, ask your teacher for your section code.
                </p>
