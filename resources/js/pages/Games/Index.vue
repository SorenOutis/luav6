                ...
                <aside class="flex flex-col gap-6">
                    ...
                    <SpotlightCard customSize glowColor="emerald" className="sidebar-card surface-card p-0 w-full min-w-0">
                        ...
                        <Motion
                            ...
                            class="relative flex flex-col w-full h-full p-5"
                        >
                            <div class="flex items-center justify-between mb-4">
                                <h2 class="text-[10px] font-black uppercase tracking-[0.2em]">Security Protocol</h2>
                                <Shield class="h-4 w-4 text-primary" />
                            </div>
                            <p class="text-[10px] leading-relaxed text-muted-foreground/70 font-medium uppercase tracking-widest">All arcade progress is verified through the core assessment engine. Exploits will result in session termination.</p>
                        </Motion>
                    </SpotlightCard>
                </aside>
            </div>
